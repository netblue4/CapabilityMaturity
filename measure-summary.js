...
function renderRiskMgmtSummaryCard(assessment) {
  ...
  return `
    <div class="card measure-card">
      ...
      <div style="display:flex;align-items:center;gap:0.4rem;margin-bottom:.25rem;padding-left:calc(90px + 0.4rem)">
        <span style="flex:1"></span>
        <span style="font-size:.62rem;font-family:var(--font-mono);text-transform:uppercase;letter-spacing:.04em;color:var(--text-muted);width:5px;text-align:left">Res</span>
